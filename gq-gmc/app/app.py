...
def updateSensor():
    ...
    try:
        ...
        triggerSensor("sensor.gmc_gq_cpm_3", "Nuclear Radiation CPM 3", gmc_serial_number, cpm, logger)
        triggerSensor("sensor.gmc_gq_usv_3", "Nuclear Radiation μSvh 3", gmc_serial_number, cpm * 0.39/60, logger)
    except Exception as e:
        logger.error(e)  
